...
func TestTemplateSQL_empty(t *testing.T) {
	...
	template, tableInfos, params, err := parser.TemplatizeSQL("")
...
func TestTemplatizeSQL_Wildcard(t *testing.T) {
	...
	template, tableInfos, params, err := parser.TemplatizeSQL(sql)
	as.Equal(nil, err)
	...
	as.Equal(models.NewTableInfo("", "users"), tableInfos[0])
...
func TestTemplateSQL_eq_gt_ge_lt_le(t *testing.T) {
	...
	as.Equal([]*models.TableInfo{models.NewTableInfo("", "tbGMallCfmH5UserDayLottery")}, tableInfos)
}
...
func TestTemplateSQL_AggregateFunc_AS(t *testing.T) {
	...
	template, tableInfos, params, err := NewSQLTemplatizer().TemplatizeSQL(sql)
	as.Equal(nil, err)
	as.Equal(
...
HAVING AVG(salary) > 50000 AND COUNT(*) > 10`
	...
	as.Equal(2, len(params))
	as.Equal([]*models.TableInfo{models.NewTableInfo("", "employees")}, tableInfos)
}
...
func TestTemplatizeSQL_ComplexUpdate(t *testing.T) {
	...
	template, tableInfos, params, err := paser.TemplatizeSQL(sql)
	as.Equal(nil, err)
...
func TestTemplateSQL_complex(t *testing.T) {
	...
	as.Equal(10, len(params))
	as.Equal([]*models.TableInfo{models.NewTableInfo("", "tb6")}, tableInfos)
}
...
func TestTemplateSQL_MultipleStatements(t *testing.T) {
	...
	template, tableInfos, params, err := psr.TemplatizeSQL(sql)
	as.Equal(nil, err)
	as.Equal(
	...
	as.Equal(int64(26), params[2])
	as.Equal("Alice", params[3])
	as.Equal("Alice", params[4])
	as.Equal(int64(25), params[5])
	as.Equal([]*models.TableInfo{
		models.NewTableInfo("", "users"),
		models.NewTableInfo("", "users"),
		models.NewTableInfo("", "users"),
	...
	_, _, _, err = psr.TemplatizeSQL(sql)
	as.Error(err)
...
func TestTemplateSQL_TimeUnit(t *testing.T) {
	...
	as.Equal(
		...
		template)
	as.Equal(1, len(params))
	as.Equal([]*models.TableInfo{models.NewTableInfo("", "tasks")}, tableInfos)
	...
	as.Equal(
		...
		template)
	as.Equal(1, len(params))
	as.Equal([]*models.TableInfo{models.NewTableInfo("", "projects")}, tableInfos)
...
func TestTemplateSQL_Explain(t *testing.T) {
	...
	as.Equal(1, len(params))
	as.Equal([]*models.TableInfo{models.NewTableInfo("", "users"), models.NewTableInfo("", "orders")}, tableInfos)
}
