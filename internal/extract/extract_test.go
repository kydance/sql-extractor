...
func TestTemplatizeSQL_empty(t *testing.T) {
	...
	as.Equal(models.SQLOperationUnknown, op)
}
...
func TestTemplatizeSQL_Insert(t *testing.T) {
	...
	as.Equal(6, len(params))
	as.Equal([]*models.TableInfo{models.NewTableInfo("", "users")}, tableInfos)
	as.Equal(models.SQLOperationInsert, op)
...
func TestTemplatizeSQL_Update(t *testing.T) {
	...
	as.Equal(7, len(params))
	as.Equal([]*models.TableInfo{models.NewTableInfo("", "users")}, tableInfos)
	as.Equal(models.SQLOperationUpdate, op)
...
func TestTemplatizeSQL_Delete(t *testing.T) {
	...
	as.Equal(1, len(params))
	as.Equal([]*models.TableInfo{models.NewTableInfo("", "users")}, tableInfos)
	as.Equal(models.SQLOperationDelete, op)
...
func TestTemplatizeSQL_Explain(t *testing.T) {
	...
	as.Equal(1, len(params))
	as.Equal([]*models.TableInfo{models.NewTableInfo("", "users")}, tableInfos)
	as.Equal(models.SQLOperationExplain, op)
